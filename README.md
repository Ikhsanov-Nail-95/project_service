...
## Project Service - сервис для работы с проектами, который позволяет пользователям организовывать работу над проектом и собирать команду для его реализации.
